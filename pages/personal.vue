  ...
  <div class="personal-edit">
    <el-tabs tab-position="left">
      <el-tab-pane label="基础信息">
        <el-form ref="baseForm" :model="baseInfo" :rules="baseFormRules" label-width="90px">
          <el-form-item label="用户ID"><el-input v-model="baseInfo.user_id" :disabled="true" /></el-form-item>
          <el-form-item prop="user_name" label="用户名称"><el-input v-model="baseInfo.user_name" /></el-form-item>
      ...
      <el-tab-pane label="修改密码">
        <el-form ref="passwordForm" :model="passwordInfo" :rules="passwordFormRules" label-width="90px">
          <el-form-item prop="user_password" label="原密码"><el-input v-model="passwordInfo.user_password" show-password style="width: 200px;" /></el-form-item>
          <el-form-item prop="new_user_password" label="新密码"><el-input v-model="passwordInfo.new_user_password" show-password style="width: 200px;" /></el-form-item>
        </el-form>
...
export default {
  data () {
    return {
      ...
      passwordFormRules: {
        user_password: [{ required: true, message: '旧密码不能为空', trigger: 'blur' }],
        new_user_password: [{ required: true, message: '新密码不能为空', trigger: 'blur' }]
      }
    }
  },
  computed: {
